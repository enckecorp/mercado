        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <table class="table table-striped table-bordered table-condensed table-hover">
                            <tr>
                                <td align="center">
                                    ...
                                    <a href="javascript:;" class="btn btn-default disabled">Mês</a>
                ...
                <div class="row">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo gastos_mes_row($data[0],$data[1]); ?></div>
                                        <div>Compras do mês <br><?php echo $data[0]."/".$data[1]; ?></div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                    ...
                    <?php
                        $result = gastos_liquidos_mes($data[0] - 1,$data[1]) - gastos_liquidos_mes($data[0],$data[1]);
                        if($result < 0){
                            $icon = "frown-o";
                        } else if($result > 0){
                            $icon = "smile-o";
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo number_format(gastos_liquidos_mes($data[0] - 1,$data[1]) - gastos_liquidos_mes($data[0],$data[1]), 2, ',', '.'); ?></div>
                                        <div>Economia mês <br><?php echo ($data[0]-1)." => ".$data[0]."/".$data[1]; ?></div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo number_format(gastos_liquidos_mes($data[0],$data[1]), 2, ',', '.'); ?></div>
                                        <div>Custo liquido mês <br><?php echo $data[0]."/".$data[1]; ?></div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo number_format(gastos_brutos_mes($data[0],$data[1]), 2, ',', '.'); ?></div>
                                        <div>Custo bruto mês <br><?php echo $data[0]."/".$data[1]; ?></div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                ...
                <?php
                    $bruto = number_format(gastos_liquidos_mes($data[0],$data[1]), 2, ',', '.');
                    $liquido = number_format(gastos_brutos_mes($data[0],$data[1]), 2, ',', '.');
                    $mes_atual = gastos_liquidos_mes($data[0],$data[1]);
                    $mes_ant = gastos_liquidos_mes($data[0]-1,$data[1]);
                    if($mes_ant != 0){
                        $percent = ($mes_atual / ($mes_ant / 100)) - 100;
                    } else {
                        $percent = 0;
                    }
                    $mes = str_pad($data[0], 2, "0", STR_PAD_LEFT);
                    $sql = mysqli_query($link,"select * from compras where data like '%/".$mes."/".$data[1]."'");
                    $options = "";
                    ...
                    <div align='center' id='conteudo'>
                        <table border='1px' cellpadding='5px' cellspacing='0' width:'100%' id='conteudo'>
                            <tr>
                                <td align='center'><b>Relatório geral mês $mes/".$data[1]."</b></td>
                            </tr>
                        </table>
                        <br>
                        <table border='1px' cellpadding='5px' cellspacing='0' width:'100%' id='conteudo'>
                        ...
                        <table border='1px' cellpadding='5px' cellspacing='0' width:'100%' id='conteudo'>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>".gastos_mes_row($data[0],$data[1])."</td>
                                    <td width='25%'>Maior compra:</td>
                                    <td>R$ ".number_format(maior_menor($data[0],$data[1],0), 2, ',', '.')."</td>
                                </tr>
                            </tbody>
                        </table>
                        <br>
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        ...
                        <?php
                            ...
                            for($i = 1; $i <= cal_days_in_month(CAL_GREGORIAN, intval($data[0]), $data[1]); $i++){
                                $dia = str_pad($i, 1, "0", STR_PAD_LEFT);
                                echo ",['$i', ".gastos_brutos_dia($dia,$data[0],$data[1])."]";
                            }
                        ?>
                        ]);

                        var options = {
                        title: 'Gastos por dia do mês <?php echo $data[0]; ?>',
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Gastos por dia do mês <?php echo $data[0]; ?></h3>
                            </div>
